...
public class PersonalSalesImpl implements PersonalSales
{
	...
	public ArrayList<Sales> getSales(String username) 
	{
		...
		for(int i = 0; i < 50; i++)
		{
			list.add(new Sales(String.valueOf(i), "img/anteater.png", "Anteater" + i, "$20000", "The anteaters are more closely related to the sloths than they are to any other group of mammals. Their next closest relations are armadillos."));
		}
